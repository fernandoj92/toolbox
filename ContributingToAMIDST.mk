...
They encompasses those contributions to the code that do not imply any major change or addition. For example, fixing a bug, adding methods to existing classes, adding new utility classes, etc. This contributions are made through a [pull request](https://help.github.com/articles/using-pull-requests/), which will be examined by the core group of developers of the project. 
...
* They should contain a readme.txt file detailing the functionality and scope of the extension. It is also needs to specify if it is supported by a companion paper, student project, etc.

* The code should be well documented following [JavaDoc](https://en.wikipedia.org/wiki/Javadoc) standards. 
 
* It has to include [JUnit](www.junit.org/) tests which verify the correctness of the results produced the provided code. 
